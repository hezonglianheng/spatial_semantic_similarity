#!/bin/bash
# =============================================================================
# 运行 simple_similarity_with_prompt.py 的 bash 脚本
# =============================================================================
# 用法:
#   ./run_simple_similarity_with_prompt.sh [选项]
#
# 示例:
#   ./run_simple_similarity_with_prompt.sh
#   ./run_simple_similarity_with_prompt.sh -m bert-base-chinese -a bert-chinese
#   ./run_simple_similarity_with_prompt.sh -d my_data.json -m /path/to/model -a my_model -o ./output
# =============================================================================
...
MODEL_NAME_OR_PATH="/root/autodl-fs/llm_models/Qwen3-8B"
...
# ---------- 打印运行信息 ----------
echo "============================================"
echo "  运行 simple_similarity_with_prompt.py"
echo "============================================"
echo "  数据文件:   ${DATA_FILE}"
...
python simple_similarity_with_prompt.py \
    --data_file "${DATA_FILE}" \
