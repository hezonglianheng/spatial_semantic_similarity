#!/bin/bash
# =============================================================================
# 批量运行 plain_similarity.py — 支持指定多个模型及其别名
# =============================================================================
# 用法:
#   ./run_plain_similarity_batch.sh [选项]
#
# 指定模型的方式 (优先级从高到低):
...
#
# 示例:
#   ./run_plain_similarity_batch.sh
#   ./run_plain_similarity_batch.sh --models "bert-base-chinese::bert-chinese Qwen/Qwen2-0.5B::qwen2-0.5b"
#   ./run_plain_similarity_batch.sh --models "bert-base-chinese::bert-chinese" -d my_data.json -o ./results
# =============================================================================
