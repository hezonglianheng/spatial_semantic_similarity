#!/bin/bash
# =============================================================================
# 运行 simple_similarity.py 的 bash 脚本
# =============================================================================
# 用法:
#   ./run_simple_similarity.sh [选项]
#
# 示例:
#   ./run_simple_similarity.sh
#   ./run_simple_similarity.sh -m bert-base-chinese -a bert-chinese
#   ./run_simple_similarity.sh -d my_data.json -m /path/to/model -a my_model -o ./output
# =============================================================================
...
MODEL_NAME_OR_PATH="/root/autodl-fs/llm_models/Qwen3-8B-embedding"
MODEL_ALIAS="Qwen3-8B-embedding"
