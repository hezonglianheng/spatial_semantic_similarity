#!/bin/bash
# =============================================================================
# 运行 similarity_with_prompts.py 的 bash 脚本
# =============================================================================
# 用法:
#   ./run_similarity_with_prompts.sh [选项]
#
# 示例:
#   ./run_similarity_with_prompts.sh
#   ./run_similarity_with_prompts.sh -m bert-base-chinese -a bert-chinese
#   ./run_similarity_with_prompts.sh -d my_data.json -m /path/to/model -a my_model -o ./output
# =============================================================================
...
# ---------- 打印运行信息 ----------
echo "============================================"
echo "  运行 similarity_with_prompts.py"
echo "============================================"
echo "  数据文件:   ${DATA_FILE}"
...
python similarity_with_prompts.py \
    --data_file "${DATA_FILE}" \
