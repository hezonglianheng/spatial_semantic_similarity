#!/bin/bash
# =============================================================================
# 批量运行 simple_similarity_with_spatial_prompt.py — 支持指定多个模型及其别名
# =============================================================================
# 用法:
#   ./run_simple_similarity_with_spatial_prompt_batch.sh [选项]
#
# 指定模型的方式 (优先级从高到低):
...
#
# 示例:
#   ./run_simple_similarity_with_spatial_prompt_batch.sh
#   ./run_simple_similarity_with_spatial_prompt_batch.sh --models "bert-base-chinese::bert-chinese Qwen/Qwen2-0.5B::qwen2-0.5b"
#   ./run_simple_similarity_with_spatial_prompt_batch.sh --models "bert-base-chinese::bert-chinese" -d my_data.json -o ./results
# =============================================================================
...
# ---------- 打印批量运行信息 ----------
echo "============================================"
echo "  批量运行 simple_similarity_with_spatial_prompt.py"
echo "============================================"
echo "  数据文件:   ${DATA_FILE}"
...
for entry in "${MODEL_ENTRIES[@]}"; do
    ...
    if python simple_similarity_with_spatial_prompt.py \
        --data_file "${DATA_FILE}" \
